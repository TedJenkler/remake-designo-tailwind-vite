...
function Hero() {
  return (
    <section className='bg-peach text-center pt-20 bg-hero-pattern-mobile bg-no-repeat bg-center bg-auto md:mx-10 md:rounded-2xl md:bg-hero-pattern-tablet md:bg-right md:pt-16 xl:mx-40 xl:flex xl:pt-36 xl:mb-0 xl:bg-hero-pattern-desktop xl:bg-tight-top xl:bg-contain'>
