...
function Keywords() {
  return (
    <section className='mb-80 md:mx-10'>
      {/* First Keyword */}
      <div className='text-center mb-20 md:flex md:items-center md:mb-8'>
        ...
        <div className='md:text-start'>
          ...
          <p className='text-base text-dark-grey font-normal mx-6 md:mx-0'>Each project starts with an in-depth brand research to ensure we only create products that serve a purpose. We merge art, design, and technology into exciting new solutions.</p>
        </div>
      </div>
      ...
      <div className='text-center mb-20 md:flex md:items-center md:mb-8'>
        ...
        <div className='md:text-start'>
          ...
          <p className='text-base text-dark-grey font-normal mx-6 md:mx-0'>Everything that we do has a strategic purpose. We use an agile approach in all of our projects and value customer collaboration. It guarantees superior results that fulfill our clients’ needs.</p>
        </div>
      </div>
      ...
      <div className='text-center mb-20 md:flex md:items-center md:mb-8'>
        ...
        <div className='md:text-start'>
          ...
          <p className='text-base text-dark-grey font-normal mx-6 md:mx-0'>We are a group of enthusiastic folks who know how to put people first. Our success depends on our customers, and we strive to give them the best experience a company can provide.</p>
        </div>
      </div>
    </section>
  );
