...
function GraphicBtn() {
  return (
    <div className='w-full h-52 flex flex-col items-center justify-center py-24 bg-plink3 bg-no-repeat rounded-2xl mb-6 brightness-100 md:bg-plink3-tablet xl:bg-plink3-s xl:w-1/2 xl:m-0'>
