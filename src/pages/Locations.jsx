...
function Locations() {
  return (
    <main className='mb-80 md:mb-96'>
      <div className='flex flex-col items-center h-screen mb-10 md:mx-10 md:mb-32'>
        <div className='h-80 w-full md:rounded-2xl md:mb-8 overflow-hidden'>
        ...
        <div className='py-20 px-6 text-center bg-bg w-full bg-locationoval bg-no-repeat bg-left-top md:rounded-2xl'>
      ...
      <div className='flex flex-col items-center h-screen md:mx-10 md:mb-32'>
        <div className='h-80 w-full mb-8 md:rounded-2xl overflow-hidden'>
      ...
      <div className='flex flex-col items-center h-screen mb-10 md:mx-10'>
        <div className='h-80 w-full md:rounded-2xl md:mb-8 overflow-hidden'>
