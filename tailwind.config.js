  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'heroaboutbg': "url('./src/assets/abouthero.png')",
        ...
        'infoabout-tablet': "url('./src/assets/infoabout.png')",
        ...
        'formbg-tablet': "url('./src/assets/formbg-tablet.png')",
        'formbg-desktop': "url('./src/assets/formbg-desktop.png')",
      },
      colors: {
        'peach': '#E7816B',
        'black': '#1D1C1E',
